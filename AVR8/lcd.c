...
{ u_char i = 8;
  ...
  while(i--) LCD_SendData( *char_buf++ ); /* Send CGRAM data (character definition). */
...
{ u_char i;
  ...
  switch( row )
  { case 0 : i = 0x80+column; break;
    case 1 : i = 0xC0+column; break;
    case 2 : i = 0x90+column; break;
    case 3 : i = 0xD0+column; break;
    default: i = 0x80+column; break;
  }
...
LCD_SendVal( val, 0 );				}       /* send command */
