...
public class InterruptTest extends InterruptThread {
	...
	public static void main(String [] args)		{
		...
		for(int i=0;i<100000;i++){
			//InterruptTest.forceInterrupt((byte)23);	//comment out for arduino; comment in for linux!
		}
...
//comment in for arduino; comment out for linux!
	public static void initTimerAndLed(){
		...
		System.platform.nativeSetData(0x44, (byte)0); // TCCR0A normal increment with overflow,
