...
char c;
// do not press q!!!
while ((c=System.in.read())!='e')System.platform.charLCDOut(c);
...
while (System.platform.conStat() != 66) 	{
	...
	System.platform.charLCDOut((char) (((b>>>4)< 10)? ((b>>>4)+'0'): ((b>>>4)+'A'-10) ));
	System.platform.charLCDOut( (char) (((b%16)< 10)? ((b%16)+'0'): ((b%16)+'A'-10) ));
						}
...
//On EVK1100, PWM0 is pin number 51 (PB19) Also, LED? is connected to PB21. //Thus, you should also see LED? blink.
...
if ((c == '-') & (pulseLength < frequency)) pulseLength = pulseLength + 1;
//if the character is '+' then decrease pulse lenght
//(increase period of high)
if ((c == '+') & (pulseLength > 0))	pulseLength = pulseLength - 1;
//if the character is 'n' then decrease frequency
if ((c == 'n') & (pulseLength < frequency))	frequency = frequency - 1;
//if the character is 'm' then increase frequency
if ((c == 'm'))					frequency = frequency + 1;
...
while((c = System.in.read())!='e')	{
	...
	switch (c)	{
		case '1':	System.out.println ("temp:"+System.platform.adcGetValue(c-'0',0)); break;
		case '2':	System.out.println ("light:"+System.platform.adcGetValue(c-'0',0)); break;
		case '3':	System.out.println ("poti:"+System.platform.adcGetValue(c-'0',0));
				}		}
}
}
